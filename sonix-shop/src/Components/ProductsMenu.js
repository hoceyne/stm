...
function ProductsMenu({ title, setProducts }) {
    ...
    return (
        <div className="relative inline-flex ml-3">
            ...
            >
                <span className="sr-only">ProductsMenu</span>
                <svg
                    className="w-4 h-4"
                    viewBox="0 0 16 16"
            ...
            <Transition
                className="origin-top-right z-10 absolute top-full right-0 -mr-36 min-w-80 bg-white border border-slate-200 py-1.5 rounded shadow-lg overflow-hidden mt-1"
                show={dropdownOpen}
